...
class Symbol {	/* **** Lay-out of symbol node **** */
    ...
    /*---------------------------------------------------------
     ...
     !--------------------------------------------------------*/
    public int GetType() {
        return IntInfo[S_Type];
    }

    public int GetKind() {
        return IntInfo[S_Kind];
    }

    public int GetInf1() {
        return IntInfo[S_Inf1];
    }

    public int GetInf2() {
        return IntInfo[S_Inf2];
    }

    public int GetQual() {
        return IntInfo[S_Inf3];
    }

    public int GetRel() {
        return IntInfo[S_Adr];
    }
    ...
    public void OutPut(outfile Fil) {
        for (int I = S_Low; I <= S_High; I = I + 1) {
            Fil.Write(IntInfo[I], 5);
        }
        if (Text != null) {
            Fil.Write(" " + Text + " ");
        } else {
