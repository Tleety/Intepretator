   ...
   {	boolean B; Token T; int Adr;
      ...
      Prec.InitBlock(0);						// block 0
		...
		{	System.out.println("");
			...
			if(T!=null){IntSats(T);}else{}	// Are there anything? Interprete this!
		}
   }
/* ****************************************************
...
* ************************************************** */
   ...
   {  Token T; boolean Slut;
      ...
      Prec.InitBlock(N);
      T=GetToken();
		/*  ### Fill in the interpretation of a block ### */
   }
	/* *****  Interpret Statement  *****
	...
	* 
	* ******************************** */
   private Token IntEmpty(){/* ### ? ### */return null;}
